...
export function init(Patchouli_js, helpers) {
  ...
  // Skyblock
  // ----------------------------------------------------
  Patchouli_js('Skyblock/A Getting Started', [
    {
      item: `minecraft:log`,
      title: 'Wood',
  ...
  Patchouli_js('Skyblock/C Metals', [
    {
      item: `minecraft:iron_ingot`,
      title: 'Iron',
  ...
  Patchouli_js('Skyblock/D Resources', [
    {
  ...
  Patchouli_js('Skyblock/E Animals', [
	{
  ...
  Patchouli_js('Skyblock/F Advance Tips', [
    {
